                ...
                <tr>
                    ...
                    <td width="60%">
                        <table width="95%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="2"><s:property value="%{#session.SYS_USER.dept}"/></td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <div class="right">
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
                ...
                <s:iterator value="#request.infoList">
                    <tr>
                        <td height="23">
    ...
    <div class="layout_center">
        <div class="lc_grzx1">
            ...
            <table width="98%" border="0" align="center">
                ...
                <s:iterator value="#request.complainList">
                <tr>
                    <td height="23">
                        <s:property value="compTitle"/>
                    </td>
                    <td width="180px"><s:property value="#complainStateMap[state]"/></td>
                    <td width="180px"><s:property value="isNM==0?'匿名':'非匿名'"/></td>
