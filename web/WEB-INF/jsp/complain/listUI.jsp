...
<head>
    ...
    <script type="text/javascript">
  	var list_url = "${basePath}complain/complain_listUI.action";
  	//搜索
  	function doSearch(){
  		//重置页号
  		//$("#pageNo").val(1);
  	...
  	function doDeal(compId){
  		document.forms[0].action = "${basePath}complain/complain_dealUI.action?complain.compId=" + compId;
  		document.forms[0].submit();
  	}

  	//统计
    function doAnnualStatistic(){
        document.forms[0].action = "${basePath}complain/complain_annualStatisticChartUI.action";
        document.forms[0].submit();
    }
    </script>
</head>
<body class="rightBody">
<form name="form1" action="${basePath}complain/complain_deal.action" method="post">
    <div class="p_d_1">
        <div class="p_d_1_1">
                       ...
                       <s:iterator value="pageResult.list" status="st">
                            <tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if> >
                                ...
                                <td align="center">
                                    ...
                                    <s:if test="state!=2">
                                    <a href="javascript:doDeal('<s:property value='compId'/>')">受理</a></s:if>
                                </td>
                            </tr>
                        </s:iterator>
                    </table>
